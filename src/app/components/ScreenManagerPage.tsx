...
const features = [
  {
    ...
    desc: "Push, pop, and replace screens with a stack API that feels obvious. Back behavior just works",
    accent: "primary" as const,
  },
  {
    icon: Sparkles,
    title: "Transitions",
    desc: "Slide, fade, or write your own. Transitions compose cleanly and clean up after themselves",
  ...
  {
    icon: Layout,
    title: "UI Toolkit Native",
    desc: "Built on UI Toolkit, not a wrapper around it. No hidden GameObjects, no weird hybrid setups",
    accent: "teal" as const,
  },
  {
    icon: Zap,
    title: "Zero Allocations",
    desc: "Pooled instances and reused elements mean smooth screen changes without GC spikes",
    accent: "primary" as const,
  },
  {
    icon: Package,
    title: "Unity Asset Store",
    desc: "Drop it into your project, point it at your UXML assets, and start shipping screens in minutes",
    accent: "teal" as const,
  },
];
            ...
            <motion.div initial="hidden" animate="visible">
              ...
              {pageIcon && (
                <motion.div variants={fadeUp} custom={0.5} className="mb-4">
                  <ImageWithFallback
                    src={pageIcon}
                    alt="UI Toolkit: Screen Manager icon"
              ...
              <motion.div variants={fadeUp} custom={4} className="flex flex-wrap gap-3">
                ...
                >
                  ...
                  <span className="text-sm uppercase tracking-wider">UI Toolkit</span>
                </div>
              </motion.div>
            </motion.div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontSize: "1.05rem" }}
            >
              Screen Manager is in active development. Want early access or have feature requests? Reach out
            </motion.p>
            <motion.div
              variants={fadeUp}
              custom={2}
