...
import { ExternalLink, Clock, CheckCircle, Zap, Wrench } from "lucide-react";
            ...
            {filtered.map((project, i) => {
              ...
              return (
                <motion.div
                  ...
                  custom={i}
                  layout
                  className={`group relative overflow-hidden bg-white/[0.04] backdrop-blur-xl border-2 border-white/[0.12] ${accent.hoverBorder} transition-all hover:-translate-y-2 ${accent.shadow} ${project.tilt} hover:rotate-0 rounded-sm ${project.slug ? "cursor-pointer" : ""} will-change-[transform,opacity]`}
                >
