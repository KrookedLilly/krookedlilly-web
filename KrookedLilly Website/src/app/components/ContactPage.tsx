            ...
            >
              ...
              {[
                ...
                <motion.div
                  ...
                  variants={fadeUp}
                  custom={i + 1}
                  className={`flex items-start gap-4 p-4 bg-white/[0.04] backdrop-blur-xl border-2 border-white/[0.12] ${styles.hoverBorder} transition-all hover:-translate-y-1 ${styles.shadow} ${item.tilt} hover:rotate-0 rounded-sm will-change-[transform,opacity]`}
                >
