          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            {upcomingItems.map((item, i) => {
              ...
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className={`group p-8 bg-white/[0.04] backdrop-blur-xl border-2 border-dashed border-white/[0.15] ${accent.hoverBorder} transition-all hover:-translate-y-2 ${accent.shadow} text-center ${item.tilt} hover:rotate-0 rounded-sm will-change-[transform,opacity]`}
              >
