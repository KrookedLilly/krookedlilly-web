import imgAutoHideHudLogo from "figma:asset/6de43b9ed8ef9068fad4d0432395cf72b82650a2.png";
import imgCardLabelerLogo from "figma:asset/ca351808c0d1e527d61f10ff447e98a827f1c2af.png";
...
import imgStorePageBackground from "figma:asset/b9360ce22316885e297785aef21ef10909b3cfea.png";
...
const mods = [
  {
    ...
    slug: "/games/he-keyboards" as string | null,
  },
  {
  ...
  },
  {
    ...
    slug: "/games/lunchbox" as string | null,
  },
  {
    title: "AutoHideHud",
    platform: "Minecraft",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <Link
              ...
              className="group block bg-white/[0.04] backdrop-blur-xl border-2 border-white/[0.12] hover:border-primary/40 rounded-sm overflow-hidden transition-all hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(160,92,246,0.12)] rotate-[0.5deg] hover:rotate-0 will-change-[transform,opacity]"
            >
            ...
            {games.map((game, i) => {
              ...
              return (
                <motion.div
                  ...
                  variants={fadeUp}
                  custom={i}
                  className={`group relative overflow-hidden bg-white/[0.04] backdrop-blur-xl border-2 border-white/[0.12] ${accent.hoverBorder} transition-all hover:-translate-y-2 ${accent.shadow} ${game.rotate} hover:rotate-0 rounded-sm ${game.slug ? "cursor-pointer" : ""} will-change-[transform,opacity]`}
                >
                  {game.slug && (
                    <Link
                      to={game.slug}
            ...
            {mods.map((mod, i) => {
              ...
              return (
                <motion.div
                  ...
                  variants={fadeUp}
                  custom={i}
                  className={`relative p-6 bg-white/[0.04] backdrop-blur-xl border-2 border-white/[0.12] ${accent.hoverBorder} transition-all hover:-translate-y-2 ${accent.shadow} ${mod.rotate} hover:rotate-0 rounded-sm ${mod.slug ? "cursor-pointer" : ""} will-change-[transform,opacity]`}
                >
                  {mod.slug && (
                    <Link
                      to={mod.slug}
